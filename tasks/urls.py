...
urlpatterns = [
    ...
    path('<int:pk>/task_change_state/', views.TaskChangeStateView.as_view(), name='task_change_state'),
    ...
    path('<int:pk>/task_overdue/', views.TaskOverdueView.as_view(), name='task_overdue'),
